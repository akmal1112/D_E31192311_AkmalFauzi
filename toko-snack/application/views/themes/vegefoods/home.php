...
<section id="home-section" class="hero">
    ...
    <div class="slider-item" style="background-image: url(<?php echo get_theme_uri('images/bg1.jpeg'); ?>);">
        <div class="overlay"></div>
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">

          <div class="col-md-12 ftco-animate text-center">
            <h1 class="mb-2">Kami Menjual Snack </h1>
            <h2 class="subheading mb-4">Snack Gurih dan Renyah</h2>
    ...
    <div class="slider-item" style="background-image: url(<?php echo get_theme_uri('images/Logo.jpeg'); ?>);">
        <div class="overlay"></div>
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">

          <div class="col-sm-12 ftco-animate text-center">
            <h1 class="mb-2">100% Renyah dan Gurih</h1>
            <h2 class="subheading mb-4">Snack Anak Muda</h2>
            <p><a href="#products" class="btn btn-primary">Belanja Sekarang</a></p>
          </div>
...
<section class="ftco-section" id="products">
    ...
    <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
      <div class="media block-6 services mb-md-0 mb-4">
        ...
        <div class="media-body">
          <h3 class="heading">Selalu Jadi Favorit</h3>
          <span>Hanya di AllOrder</span>
        </div>
      </div>    
    </div>
    <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
  ...
  <div class="container">
          ...
          <div class="col-md-6 heading-section ftco-animate deal-of-the-day ftco-animate" style="background-image: url();"><img class="img-fluid" src="<?php echo base_url('assets/uploads/products/'. $best_deal->picture_name); ?>" ></div>
